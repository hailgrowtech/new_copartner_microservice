...
using MarketingContentService.Logic;
...
using MarketingContentService.Configuration;
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "Marketing Content Service API",
        Version = "v1",
...
if (app.Environment.IsDevelopment() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Marketing Content Service API V1");
    });
}
