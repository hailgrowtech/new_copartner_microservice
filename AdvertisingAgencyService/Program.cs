using AdvertisingAgencyService.Logic;
using FluentValidation;
using Microsoft.OpenApi.Models;
using MigrationDB.Data;
using Serilog;
using System.Reflection;
using AdvertisingAgencyService.Configuration;
using CommonLibrary.Authorization; 
using AdvertisingAgencyService.Profiles;
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "Advertising Agency Service API",
        Version = "v1",
        Description = "An API to perform Advertising Agency Details operations",
...
if (app.Environment.IsDevelopment() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Advertising Agency Service API V1");
    });
}
