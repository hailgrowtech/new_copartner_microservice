...
public class AutoMapperProfile : Profile
{
    public AutoMapperProfile()
    {
        ...
        // Source -> Target
        CreateMap<APGeneratedLinks, APGeneratedLinkReadDTO>().ReverseMap();
        CreateMap<APGeneratedLinks, APGeneratedLinkCreateDTO>().ReverseMap();
        //CreateMap<APListingDto, APListingReadDto>().ReverseMap();
        //CreateMap<APDetailDto, APDetailReadDto>().ReverseMap();
        CreateMap<APGeneratedLinks, JsonPatchDocument<APGeneratedLinkCreateDTO>>().ReverseMap();
        CreateMap<APGeneratedLinks, ResponseDto>()
            .ForMember(dest => dest.Data, opt => opt.MapFrom(src => src)); // Map APGeneratedLink entity to ResponseDto's Data property
