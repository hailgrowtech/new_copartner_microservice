...
using ContactService.Configuration; 
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "Contact Us Service API",
        Version = "v1",
        Description = "An API to perform Contact Us operations",
...
builder.Services.AddScoped<IContactUsBusinessProcessor, ContactUsBusinessProcessor>();
